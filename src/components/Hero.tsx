    ...
    <section className="relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4 pb-8">
        <div className="text-center max-w-[46rem] mx-auto ">
          ...
          {/* Render Description if provided */}
          {description && (
            <Body className="mt-4 max-w-[43rem] mx-auto !text-[#808080] font-inter-tight font-medium text-[18px] leading-[24px] text-center align-middle   md:text-sm [@media(max-width:375px)]:text-[16px] [@media(max-width:375px)]:font-[500] [@media(max-width:375px)]:leading-[24px]  ">
              {description}
            </Body>
          )}
