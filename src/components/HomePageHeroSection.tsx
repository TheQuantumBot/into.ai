    ...
    <ScrollAnimation>
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4 pb-8">
          <div className="fade-up text-center mx-auto">
            ...
            {description && (
              <Body className="fade-up mt-2 font-inter-tight font-medium text-[18px] leading-[24px] max-w-[44rem] flex items-center justify-center mx-auto mt-[14px] align-middle !text-[#4C4C4C]">
                {description}
              </Body>
            )}
