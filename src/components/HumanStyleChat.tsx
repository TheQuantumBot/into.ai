    ...
    <section className="py-20 px-6">
      <div className="max-w-7xl  mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative ">
          ...
          <h2 className="text-6xl leading-[66px] mt-[14px] font-bold text-gray-900 ">
            Human-Style <br /> Conversations <br />
            <span className="gradient-text">That Build Trust</span>
          </h2>
          <div className="mt-4 space-y-[14px]">
            ...
            <p className="text-gray-500 text-lg leading-6">
              SalesBot adapts to tone, reads context, and responds thoughtfully,
              so conversations feel friendly, natural, and consultative, not
              robotic.
            </p>

            <p className="gradient-text text-lg flex flex-row gap-1 leading-6">
              <Image src="Replies.svg" alt="Replies" width={20} height={20} />
              More replies.{" "}
              <Image
                src="Support.svg"
                alt="Support"
