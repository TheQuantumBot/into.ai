          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="fade-up text-4xl sm:text-5xl lg:text-6xl font-[600] text-gray-900 leading-tight">
                  Become an{" "}
              ...
              <p className="fade-up text-lg text-black leading-relaxed max-w-md">
                Build a recurring income stream by promoting the future of
                AI-driven sales - zero investment, full support, and lifetime
                earning potential.
              </p>

              <p className="fade-up text-base text-gray-600 leading-relaxed max-w-md">
              ...
              <p className="fade-up text-base text-gray-600 leading-relaxed max-w-md">
                Now, we’re opening doors for partners who want to grow with the
                AI revolution. Bring your network.  we’ll handle the tech,
