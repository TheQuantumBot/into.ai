...
export default function ButtonPrimary({
  ...
  return (
    <>
      <button
        className={`relative overflow-hidden px-3 py-2 md:px-3 sm:px-[10px] [@media(max-width:375px)]:px-[7px] sm:py-3 
          min-w-[120px] sm:min-w-[150px] flex items-center justify-center gap-1 sm:gap-2 
          text-black font-semibold text-sm sm:text-lg tracking-wide rounded-lg bg-white font-inter outline-none 
          border-[2px] border-[#DED8D3] transition-all duration-300 active:translate-y-[-1px] hover:bg-gray-100
          ${className}`}
        {...props}
      >
        {/* SVG Icon (Fixed Left) */}
