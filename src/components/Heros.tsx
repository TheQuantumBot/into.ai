          ...
          <div className="text-center max-w-[44rem] mx-auto">
            ...
            {title && (
              <BlurText
                ...
                animateBy="words"
                direction="top"
                className={`fade-up text-4xl sm:text-5xl md:text-6xl font-[600] text-center ${
            ...
            {description && (
              <Body className="fade-up mt-2 font-inter-tight font-medium text-[18px] leading-[24px] text-center align-middle !text-[#4C4C4C]">
                {description}
              </Body>
            )}
            ...
            {(primaryButtonText || secondaryButtonText) && (
              <div className="fade-up flex items-center justify-center my-4 gap-2">
                {primaryButtonText && (
                  <div>
                    <ButtonPrimary
                      onClick={() => {
